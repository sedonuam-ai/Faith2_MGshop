...
3. Mettez **tous les fichiers de ce dossier** à la racine du dépôt (tous au même niveau, sans créer de sous-dossier) :
   - `index.html`, `manifest.json`, `service-worker.js`, `README.md`
   - `icon-192.png`, `icon-512.png`, `icon-192-maskable.png`, `icon-512-maskable.png`, `favicon-32.png`, `apple-touch-icon.png`
   - Sur GitHub, utilisez **"Add file" → "Upload files"** et glissez TOUS ces fichiers en une seule fois (ne créez pas de dossier "icons").
     ```
     git init
     git add .
